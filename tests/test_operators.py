...
def test_symmetric() -> None:
    ...
    """
    assert_close(mul(1.0, 2.0), mul(2.0, 1.0))
    assert_close(mul(1.0, 2.0), 2.0)
    assert_close(mul(2.0, 1.0), 2.0)
...
def test_distribute() -> None:
    ...
    """
    assert_close( mul(2.0, add(1.0, 3.0)), add(mul(2.0, 1.0), mul(2.0, 3.0)))
    assert_close( mul(2.0, add(1.0, 3.0)), 8.0)
